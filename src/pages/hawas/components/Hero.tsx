...
export const Hero: React.FC<HeroProps> = ({
  ...
  // Select top featured items from the Rasasi Hawas Collection for the right stack
  ...
  const featuredCards = [
    {
      category: 'RASASI HAWAS COLLECTION',
      title: pForHim ? pForHim.name : 'Hawas for Him by Rasasi',
    ...
    {
      category: 'RASASI HAWAS COLLECTION',
      title: pBlack ? pBlack.name : 'Hawas Black by Rasasi',
    ...
    {
      category: 'RASASI HAWAS COLLECTION',
      title: pFire ? pFire.name : 'Hawas Fire by Rasasi',
      ...
      <div className="max-w-7xl mx-auto px-3 sm:px-6 lg:px-8 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 sm:gap-10 items-center">
          ...
          <div className="lg:col-span-7 space-y-4 sm:space-y-6 text-center lg:text-left">
            ...
            {/* Main Headline for Hawas Landing Page */}
            ...
            <p className="text-xs sm:text-base text-slate-600 leading-relaxed max-w-2xl mx-auto lg:mx-0 font-normal">
              Experience the legendary Rasasi Hawas collection — Hawas for Him, Hawas Ice, Hawas Black, Hawas Fire, and Hawas Pink. 100% original imported fragrances delivered fast across Juba.
            </p>
