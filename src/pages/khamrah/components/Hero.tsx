...
export const Hero: React.FC<HeroProps> = ({
  ...
  // Select the featured Lattafa Khamrah trio for the right stack, by array
  // index rather than hardcoded IDs, so admin-added products still work.
  const featuredCards = perfumes.slice(0, 3).map((p) => ({
    category: 'LATTAFA KHAMRAH COLLECTION',
    title: p.name,
    priceUSD: p.priceUSD,
    originalPriceUSD: p.originalPriceUSD,
    savingsUSD: p.originalPriceUSD - p.priceUSD,
    image: p.image,
    product: p,
  }));
      ...
      <div className="max-w-7xl mx-auto px-3 sm:px-6 lg:px-8 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 sm:gap-10 items-center">
          ...
          <div className="lg:col-span-7 space-y-4 sm:space-y-6 text-center lg:text-left">
            ...
            {/* Main Headline for Khamrah Landing Page */}
            ...
            <p className="text-xs sm:text-base text-slate-600 leading-relaxed max-w-2xl mx-auto lg:mx-0 font-normal">
              Experience the legendary Lattafa Khamrah collection — Khamrah for Him, Khamrah Ice, Khamrah Black, Khamrah Fire, and Khamrah Pink. 100% original imported fragrances delivered fast across Juba.
            </p>
