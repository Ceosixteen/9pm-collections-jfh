...
const COLLECTIONS: CollectionCard[] = [
  ...
  {
    slug: ‘nivea-spray’,
    to: ‘/collections/nivea-spray’,
    name: ‘Nivea Deodorant Spray’,
    subtitle: ‘Dry Comfort, Black & White, Protect & Care & more — 6 variants’,
    image: ‘/images/nivea_spray_dry_comfort.png’,
    badge: ‘Deodorant’,
  },
  {
    slug: ‘nivea-lotion’,
    to: ‘/collections/nivea-lotion’,
    name: ‘Nivea Body Lotion’,
    subtitle: ‘Aloe Hydration, Express, Soft Milk & Cocoa Butter’,
    image: ‘/images/nivea_lotion_aloe_hydration.png’,
    badge: ‘Body Care’,
  },
  {
    slug: ‘pantene’,
    to: ‘/collections/pantene’,
    name: ‘Pantene Pro-V Shampoo’,
    subtitle: ‘Anti-Dandruff, Moisture Renewal, Smooth & Sleek & more’,
    image: ‘/images/pantene_anti_dandruff.jpg’,
    badge: ‘Hair Care’,
  },
];
