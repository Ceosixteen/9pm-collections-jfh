      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center space-y-3 max-w-3xl mx-auto mb-12">
          ...
          <h2 className="text-3xl sm:text-4xl lg:text-5xl font-black text-slate-900 tracking-tight font-sans">
            Special Skincare Bundle Deals
          </h2>
          <p className="text-sm sm:text-base text-slate-600 font-normal">
            Save up to <strong className="text-[#B24BF3] font-bold">$40 USD (320,000 SSP)</strong> when you bundle multiple products together. Instant same-day delivery across Juba Town!
          </p>
        </div>
                ...
                <div className="space-y-4">
                  ...
                  <div className="space-y-2 pt-2">
                    <span className="text-[10px] font-extrabold text-slate-400 uppercase tracking-wider block">
                      INCLUDED IN THIS BUNDLE ({bundledPerfumes.length} PRODUCTS):
                    </span>
                      ...
                      {bundledPerfumes.map((p) => (
                        <div key={p.id} className="flex items-center gap-2 p-2 rounded-xl bg-slate-50 border border-gray-100">
                          ...
                          <div className="min-w-0">
                            ...
                            <span className="text-[10px] text-gray-500 block truncate">{p.timeTag === 'CLEANSE' ? 'Cleanser' : 'Skincare'}</span>
                          </div>
                        </div>
                      ))}
                    </div>
