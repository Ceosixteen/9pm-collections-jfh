  ...
  const steps = [
    {
      step: "01",
      icon: ShoppingBag,
      title: "1. Select Your Skincare",
      desc: "Choose from CeraVe cleansers, toner, moisturizers, or the Resurfacing Retinol Serum. Bundle 2+ products for automatic -$5 off every item!"
    },
    {
      step: "02",
      icon: MapPin,
