          ...
          <div className="md:col-span-7 space-y-4">
            ...
            <div className="grid grid-cols-3 gap-2.5 text-xs">
              <div className="p-2.5 rounded-xl bg-slate-50 border border-gray-100">
                <span className="text-gray-400 block text-[9px] uppercase font-extrabold">FORMULA</span>
                <span className="text-slate-900 font-bold text-[11px]">{perfume.concentration || perfume.volume}</span>
              </div>
              <div className="p-2.5 rounded-xl bg-slate-50 border border-gray-100">
                <span className="text-gray-400 block text-[9px] uppercase font-extrabold">TEXTURE</span>
                <span className="text-slate-900 font-bold text-[11px]">{perfume.projection}</span>
              </div>
              <div className="p-2.5 rounded-xl bg-slate-50 border border-gray-100">
                <span className="text-gray-400 block text-[9px] uppercase font-extrabold">RESULTS</span>
              ...
              <div className="space-y-2 text-xs">
                <div className="p-2.5 rounded-xl bg-gray-50 border border-gray-100">
                  <div className="flex items-center justify-between">
                    <span className="font-extrabold text-[#B24BF3]">Key Actives:</span>
                ...
                <div className="p-2.5 rounded-xl bg-gray-50 border border-gray-100">
                  <div className="flex items-center justify-between">
                    <span className="font-extrabold text-[#B24BF3]">Supporting Ingredients:</span>
                ...
                <div className="p-2.5 rounded-xl bg-gray-50 border border-gray-100">
                  <div className="flex items-center justify-between">
                    <span className="font-extrabold text-[#B24BF3]">Barrier Support:</span>
