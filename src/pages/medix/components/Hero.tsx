...
export const Hero: React.FC<HeroProps> = ({
  ...
  // Select top featured items from the Medix 5.5 Collection for the right stack
  ...
  const featuredCards = [
    {
      category: 'MEDIX 5.5 BODY COLLECTION',
      title: pVitC ? pVitC.name : 'Medix 5.5 Vitamin C + Turmeric Body Lotion',
    ...
    {
      category: 'MEDIX 5.5 BODY COLLECTION',
      title: pArgan ? pArgan.name : 'Medix 5.5 Argan Oil + Vitamin E Body Cream',
    ...
    {
      category: 'MEDIX 5.5 BODY COLLECTION',
      title: pRetinol ? pRetinol.name : 'Medix 5.5 Retinol + Ferulic Acid Age Rewind Body Cream',
      ...
      <div className="max-w-7xl mx-auto px-3 sm:px-6 lg:px-8 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 sm:gap-10 items-center">
          ...
          <div className="lg:col-span-7 space-y-4 sm:space-y-6 text-center lg:text-left">
            ...
            {/* Main Headline for Medix 5.5 Landing Page */}
            <h1 className="text-2xl sm:text-4xl lg:text-6xl font-black text-slate-900 tracking-tight leading-tight sm:leading-none font-sans">
              Medix 5.5 Body Lotion Collection,{' '}
            ...
            <p className="text-xs sm:text-base text-slate-600 leading-relaxed max-w-2xl mx-auto lg:mx-0 font-normal">
              Dermatologist-tested, active-infused body lotions and creams — Vitamin C, Argan Oil, Retinol, and Hyaluronic Acid formulas that target texture, tone, and aging from the neck down. 100% original, delivered fast across Juba.
            </p>
