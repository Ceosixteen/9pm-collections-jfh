...
export const Hero: React.FC<HeroProps> = ({
  ...
  // Select top featured items from the Dove Beauty Bar Collection for the right stack
  ...
  const featuredCards = [
    {
      category: 'DOVE BEAUTY BAR COLLECTION',
      title: pVitC ? pVitC.name : 'Dove Beauty Bar Vitamin C + Turmeric Body Lotion',
    ...
    {
      category: 'DOVE BEAUTY BAR COLLECTION',
      title: pArgan ? pArgan.name : 'Dove Beauty Bar Argan Oil + Vitamin E Body Cream',
    ...
    {
      category: 'DOVE BEAUTY BAR COLLECTION',
      title: pRetinol ? pRetinol.name : 'Dove Beauty Bar Retinol + Ferulic Acid Age Rewind Body Cream',
      ...
      <div className="max-w-7xl mx-auto px-3 sm:px-6 lg:px-8 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 sm:gap-10 items-center">
          ...
          <div className="lg:col-span-7 space-y-4 sm:space-y-6 text-center lg:text-left">
            ...
            {/* Main Headline for Dove Beauty Bar Landing Page */}
            ...
            <p className="text-xs sm:text-base text-slate-600 leading-relaxed max-w-2xl mx-auto lg:mx-0 font-normal">
              Dermatologist-tested, active-infused beauty bars — Vitamin C, Argan Oil, Retinol, and Hyaluronic Acid formulas that target texture, tone, and aging from the neck down. 100% original, delivered fast across Juba.
            </p>
            ...
            <div className="space-y-2 pt-1">
              <div className="grid grid-cols-2 sm:flex sm:flex-row items-center justify-center lg:justify-start gap-2.5">
                ...
                >
                  <span>Shop Dove Beauty Bar</span>
