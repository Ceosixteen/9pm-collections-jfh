...
export default function App() {
  ...
  const perfumes = useCollectionProducts<PerfumeProduct>('nine-collection', PERFUMES_DATA);
  ...
  // Runs against `perfumes` (not the static list) so admin-added products
  // work too, and the ref guard keeps it firing only once.
