...
export const Hero: React.FC<HeroProps> = ({
  ...
  // Select top featured items from the Nivea Men Shower Gel Collection for the right stack
  const p0 = perfumes[0];
  const p1 = perfumes[1];
  const p2 = perfumes[2];
  ...
  const featuredCards = [
    {
      category: 'NIVEA MEN SHOWER GEL COLLECTION',
      title: p0 ? p0.name : 'Nivea Men Energy 24hr Fresh Effect Shower Gel (250ml)',
      priceUSD: p0 ? p0.priceUSD : 20,
      originalPriceUSD: p0 ? p0.originalPriceUSD : 20,
      savingsUSD: p0 ? p0.originalPriceUSD - p0.priceUSD : 0,
      image: p0 ? p0.image : '',
      product: p0 || perfumes[0],
    },
    {
      category: 'NIVEA MEN SHOWER GEL COLLECTION',
      title: p1 ? p1.name : 'Nivea Men Cool Kick Shower Gel (250ml)',
      priceUSD: p1 ? p1.priceUSD : 20,
      originalPriceUSD: p1 ? p1.originalPriceUSD : 20,
      savingsUSD: p1 ? p1.originalPriceUSD - p1.priceUSD : 0,
      image: p1 ? p1.image : '',
      product: p1 || perfumes[0],
    },
    {
      category: 'NIVEA MEN SHOWER GEL COLLECTION',
      title: p2 ? p2.name : 'Nivea Men Sensitive Shower Gel (250ml)',
      priceUSD: p2 ? p2.priceUSD : 20,
      originalPriceUSD: p2 ? p2.originalPriceUSD : 20,
      savingsUSD: p2 ? p2.originalPriceUSD - p2.priceUSD : 0,
      image: p2 ? p2.image : '',
      product: p2 || perfumes[0],
    },
  ];
      ...
      <div className="max-w-7xl mx-auto px-3 sm:px-6 lg:px-8 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 sm:gap-10 items-center">
          ...
          <div className="lg:col-span-7 space-y-4 sm:space-y-6 text-center lg:text-left">
            ...
            {/* Main Headline for Nivea Men Shower Gel Landing Page */}
            <h1 className="text-2xl sm:text-4xl lg:text-6xl font-black text-slate-900 tracking-tight leading-tight sm:leading-none font-sans">
              Nivea Men Shower Gel Collection,{' '}
            ...
            <p className="text-xs sm:text-base text-slate-600 leading-relaxed max-w-2xl mx-auto lg:mx-0 font-normal">
              Dermatologist-tested, active-infused shower gels — Vitamin C, Argan Oil, Retinol, and Hyaluronic Acid formulas that target texture, tone, and aging from the neck down. 100% original, delivered fast across Juba.
            </p>
            ...
            <div className="space-y-2 pt-1">
              <div className="grid grid-cols-2 sm:flex sm:flex-row items-center justify-center lg:justify-start gap-2.5">
                ...
                >
                  <span>Shop Nivea Men Shower Gel</span>
