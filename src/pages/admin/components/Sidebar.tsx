...
import { LayoutDashboard, ShoppingBag, Users, Layers, MessageCircleQuestion, Mail, Megaphone, Package, LogOut } from 'lucide-react';

export type AdminView = 'overview' | 'orders' | 'products' | 'clients' | 'pages' | 'help' | 'leads' | 'campaigns';
