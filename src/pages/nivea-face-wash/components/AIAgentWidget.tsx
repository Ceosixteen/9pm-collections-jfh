  ...
  const [messages, setMessages] = useState<ChatMessage[]>([
    {
      id: 'msg-welcome',
      sender: 'agent',
      text: 'Jambo! Welcome to Juba Fashion Hub. I\'m Amina from our sales team. What is your skin dealing with today — dryness, dullness, aging, or just want a full Nivea Men Face Wash face-care routine?',
      timestamp: new Date().toLocaleTimeString([], { hour: '2-digit', minute: '2-digit' }),
      quickActions: [
        { label: '✨ Best for Dry Skin', action: 'Which Nivea Men Face Wash product is best for very dry or flaky skin?' },
