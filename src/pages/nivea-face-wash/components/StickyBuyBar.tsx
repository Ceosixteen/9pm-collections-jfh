      ...
      <div className="max-w-7xl mx-auto flex items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            <div className="flex items-center gap-1.5 text-xs font-bold text-slate-900">
              <span className="text-[#B24BF3] font-black">-$5 USD (40,000 SSP) OFF EVERY ITEM!</span>
            </div>
            <span className="text-[10px] text-slate-500 hidden sm:block font-medium">
              Add 2 or more products to automatically unlock bundle discount · Free Juba Express Dispatch
            </span>
          </div>
        </div>
        ...
        <div className="flex items-center gap-2">
          ...
          >
            ...
            <span className="hidden sm:inline">Add Best Seller (Dark Spot Face Wash)</span>
