...
export const Hero: React.FC<HeroProps> = ({
  ...
  // Select top featured items from the Signature Fragrances for Men for the right stack
  ...
  const featuredCards = [
    {
      category: 'SIGNATURE FRAGRANCES FOR MEN',
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 sm:gap-10 items-center">
          ...
          <div className="lg:col-span-7 space-y-4 sm:space-y-6 text-center lg:text-left">
            ...
            <p className="text-xs sm:text-base text-slate-600 leading-relaxed max-w-2xl mx-auto lg:mx-0 font-normal">
              Experience the legendary Lattafa Signature Men collection — Signature for Him, Signature Ice, Signature Black, Signature Fire, and Signature Pink. 100% original imported fragrances delivered fast across Juba.
            </p>
