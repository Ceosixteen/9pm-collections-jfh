  ...
  const steps = [
    {
      step: "01",
      icon: ShoppingBag,
      title: "1. Select Your Fragrance",
      desc: "Choose from Signature for Him, Signature Ice, Signature Black, Signature Fire, or Signature Pink. Bundle 2+ bottles for automatic -$5 off every bottle!"
    },
    {
      step: "02",
      icon: MapPin,
