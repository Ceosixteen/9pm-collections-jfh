...
const SITE_URL = 'https://jubafashionhub.link';
...
const PAGES = [
    ...
    jsonLd: {
      ...
      hasOfferCatalog: {
        ...
        itemListElement: [
          ...
          { '@type': 'OfferCatalog', name: 'Medix 5.5 Body Care Collection', url: `${SITE_URL}/collections/medix` },
        ],
      },
    },
  },
  ...
  {
    route: '/collections/medix',
    outFile: 'collections/medix/index.html',
    title: 'Medix 5.5 Body Care Collection | Juba Fashion Hub',
    description:
      'Shop the Medix 5.5 Body Lotion Collection — Vitamin C + Turmeric, Argan Oil + Vitamin E, Retinol + Ferulic Acid, and Hyaluronic Acid + Cica. 100% authentic imports, free express delivery across Juba.',
    image: '/images/medix_placeholder.svg',
    jsonLd: {
      '@context': 'https://schema.org',
      '@type': 'ItemList',
      name: 'Medix 5.5 Body Care Collection',
      url: `${SITE_URL}/collections/medix`,
      itemListElement: [
        { '@type': 'Product', position: 1, name: 'Medix 5.5 Vitamin C + Turmeric Body Lotion', image: `${SITE_URL}/images/medix_placeholder.svg`, offers: { '@type': 'Offer', priceCurrency: 'USD', price: '25' } },
        { '@type': 'Product', position: 2, name: 'Medix 5.5 Argan Oil + Vitamin E Body Cream', image: `${SITE_URL}/images/medix_placeholder.svg`, offers: { '@type': 'Offer', priceCurrency: 'USD', price: '25' } },
        { '@type': 'Product', position: 3, name: 'Medix 5.5 Retinol + Ferulic Acid Age Rewind Body Cream', image: `${SITE_URL}/images/medix_placeholder.svg`, offers: { '@type': 'Offer', priceCurrency: 'USD', price: '25' } },
        { '@type': 'Product', position: 4, name: 'Medix 5.5 Hyaluronic Acid + Cica Body Cream', image: `${SITE_URL}/images/medix_placeholder.svg`, offers: { '@type': 'Offer', priceCurrency: 'USD', price: '25' } },
      ],
    },
  },
];
